...
if on_production_server:
    DEFAULT_FROM_EMAIL = 'prayer.dev@gmail.com'
    SERVER_EMAIL = DEFAULT_FROM_EMAIL

# Make this unique, and don't share it with anybody.
SECRET_KEY = '5dr$p&2zcnbq_#c8(boqqc15qrho=ld*cb&&ai0pc910(wy5q9'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    # distinguish whether the user logged in via Google or Django 
...
EMAIL_PORT              = 587
EMAIL_HOST_USER         = 'prayer.dev@gmail.com'
EMAIL_HOST_PASSWORD     = 'LoveInHim'
EMAIL_USE_TLS           = True
